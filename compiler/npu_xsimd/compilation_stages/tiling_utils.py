...
if TYPE_CHECKING:
    from op_templates.adl import ArchitectureNode
    from op_templates.op_instance import OperationInstance

from .stage_structures import TilingInfo
from op_templates.compiler.transformations import factors, factors_rand_sort, \
...
def get_tile_constraints(cdlt: 'OperationInstance', hag: 'ArchitectureNode', tile_info: TilingInfo):
    path_constraints = {}
...
def set_codelet_tiling(cdlt: 'OperationInstance',
    ...
    if level == 0:
        ...
        raise RuntimeError(f"Unable to find adequate tiling for OperationInstance {cdlt.cdlt_uid}:"
...
def set_dw_conv_tiling(cdlt: 'OperationInstance',
                       hag: 'ArchitectureNode',
                       factor_fn_name,
                       stopping_condition,
                       selection_metric,
