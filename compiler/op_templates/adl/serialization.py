...
import dill
from op_templates.adl.graph import ComputeNode, StorageNode, CommunicationNode, ArchitectureNode
from op_templates.adl.flex_template import Instruction
...
def _deserialize_codelets(capabilities: List[Instruction], codelet_list):
    ...
    for cdlt_obj in codelet_list:
        ...
        cdlt = OperationInstance(*args, **kwargs)
