...
def default_tile_heuristic(hag: 'ArchitectureNode', cdlt: 'OperationInstance', tiling_splits):
    total_accesses = 0
...
def insert_simd_typecast(program: 'CodeletProgram', node, operand, cdlt: 'OperationInstance', dtype_map, codelet_output_map, key):
    if cdlt.is_noop():
        pass
