...
from op_templates.adl.operation import Operation, Loop, Transfer, Compute, Configure, Operand, Datatype, LoopEnd
...
class OperationInstance(object):
    ...
    def __init__(self, op_name,
        ...
        if self.is_instance:
            self._instance_id = OperationInstance.codelet_instance_id
            OperationInstance.codelet_instance_id += 1

        if cdlt_id:
            self._cdlt_id = cdlt_id
        else:
            self._cdlt_id = OperationInstance.codelet_id
            OperationInstance.codelet_id += 1
    ...
    @staticmethod
    def reset():
        OperationInstance.codelet_instance_id = 0
        OperationInstance.codelet_id = 0
    ...
    def copy(self, pre_increment=False):
        ...
        obj._instance_id = OperationInstance.codelet_instance_id
