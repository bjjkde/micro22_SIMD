...
from op_templates.graph import Node, Graph
...
import itertools
import dill
from op_templates.adl.flex_template import Instruction, FlexTemplate
...
class ArchitectureNode(Node):
    ...
    @property
    def codelets(self) -> Dict[str, 'OperationInstance']:
    ...
    def add_codelet(self, codelet: 'OperationInstance'):
    ...
    def get_codelet_template(self, name) -> Union['OperationInstance', 'CodeletTemplate']:
        ...
        raise KeyError(f"OperationInstance {name} not found!")
