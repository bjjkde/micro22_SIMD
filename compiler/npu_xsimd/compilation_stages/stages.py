...
from op_templates.templates.operand_template import IndexOperandTemplate
from op_templates.adl.graph import ArchitectureNode
from op_templates.templates.op_template import CodeletTemplate
from op_templates.op_instance import OperationInstance
from op_templates.op_instance.op_instance import USE_LOOP_END
from op_templates.compiler.program import CodeletProgram
...
def quantize_codelet(program: 'CodeletProgram', node: pm.Node, cdlt: 'OperationInstance') -> 'OperationInstance':

    return cdlt

def update_operand_dtypes(program: 'CodeletProgram', node: pm.Node, cdlt: 'OperationInstance', dtype_map=None) -> 'OperationInstance':
...
def add_simd_typecast(program: 'CodeletProgram', node: pm.Node, cdlt: 'OperationInstance', dtype_map=None,
                      codelet_output_map=None) -> 'OperationInstance':
...
def remove_unused_variables(program: 'CodeletProgram', node: pm.Node, cdlt: 'OperationInstance', shaped_nodes=None) -> 'OperationInstance':
...
def propagate_offsets(cdlt: 'OperationInstance', hag: 'ArchitectureNode') -> 'OperationInstance':
...
def tile(program: 'CodeletProgram', node: pm.Node, cdlt: 'OperationInstance', factor_fn_name='default', heuristic_fn=None,
         checkpoint_file=None, stopping_condition=None, selection_metric=None) -> 'OperationInstance':
    hag = program.hag
...
def separate_simd_sa_ops(program: 'CodeletProgram', node: pm.Node, cdlt: 'OperationInstance') -> 'OperationInstance':

    return cdlt

def hoist(program, node: pm.Node, cdlt: 'OperationInstance') -> 'OperationInstance':
    for o in cdlt.ops:
