...
if TYPE_CHECKING:
    from op_templates.adl.operation import Operation, Loop, Compute, Configure, Transfer
...
def split_loop(cdlt: 'OperationInstance', outer_loop: 'Loop', inner_loop: 'Loop', inner_tile_level: int):
...
def split_transfer(cdlt: 'OperationInstance', outer_xfer: 'Transfer', inner_xfer: 'Transfer'):
...
def split_operation(cdlt: 'OperationInstance', op: 'Operation', loop_level: int, tile_level: int):
...
def lift_operations(cdlt: 'OperationInstance'):
