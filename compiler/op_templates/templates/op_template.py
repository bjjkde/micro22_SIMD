...
from op_templates.common import Datatype, get_full_obj_type
...
from op_templates.adl.operation import Operation
...
class CodeletTemplate(object):
    ...
    def instantiate(self, instance_args):
        ...
        contexts = deque()
        with OperationInstance(self.op_name, inputs, outputs, instance_args['HAGPlaceholder']) as cdlt:
            cdlt._temps = temps
        ...
        cdlt._instance_id = OperationInstance.codelet_instance_id
        self.reset_params()
        return cdlt
