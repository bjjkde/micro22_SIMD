from op_templates.adl.graph import ComputeNode, StorageNode
from op_templates import initialize_program
...
from .npu_xsimd_instructions import GENESYS_INSTRUCTIONS
...
from .op_templates import GENESYS_CODELETS, FUSION_OP_INFO
...
from op_templates.adl.serialization import deserialize_hag
...
def define_genesys(cfg):
    ...
    with ComputeNode("Genesys") as hag:
        ...
        # OperationInstance start and end
...
def compile_genesys(model_name,
    ...
    # OperationInstance compilation starts here
